    ...
    movies.forEach((movie) => {
      if (movie.on_sale) {
        productWrapper.innerHTML += `
                                   <div class="movie">
                                     <a href="product_error.html?id=${movie.id}&title=${movie.name}" class="movieImage">
                                     ...
                                     <a href="product_error.html?id=${movie.id}&title=${movie.name}" class="cta-button">Add to cart</a>
                                   </div>`;
      } else {
        productWrapper.innerHTML += `
                                   <div class="movie">
